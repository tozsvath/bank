...
helm.sh/chart: {{ include "bank-chart.chart" . }}
...
*/}}
{{- define "bank-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "bank-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
